...
import style from './fineTuneImage.module.css';
export default function FineTuneImage({picture,contrast,saturate,brightness}){
    ...
    useEffect(()=>{
       ...
       },[picture,contrast,brightness,saturate]);
    ...
    return (
      <>
        <div style={{ position: "relative" }}>
          <canvas
            ref={canvasRef}
            width={picture.width * 1.3}
            height={picture.height *1.3}
            style={{
              display: "block",
              margin: "auto",
              width: "auto",
